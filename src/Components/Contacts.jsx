...
function Contacts() {
  ...
  const [newContact, setNewContact] = useState({
    ...
    email: "",
    phone: "",
  }); // passed the initial state as argument
  ...
  const handleDeleteConfirmation = () => {
    ...
    axios
      .delete(`https://jsonplaceholder.typicode.com/users/${deleteContact.id}`)
      .then((res) => {
  ...
  return (
    ...
    <div className="container">
      ...
      {/* this will run when the confirmation for delete contact is true */}
      {showDeleteConfirmation && (
        <div className="modal">
          <p style={{ color: "white" }}>
            Are you sure want to delete {deleteContact.name}
          </p>
